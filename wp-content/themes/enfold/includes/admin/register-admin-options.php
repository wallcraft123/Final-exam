...
$avia_elements[] = array(
						...
						'desc'		=> __( 'Select if you want to use any of your pages as your custom Error 404 Page. This page will will be excluded from page lists and search results.', 'avia_framework' ),
						'id'		=> 'error404_custom',
						'type'		=> 'select',
						'no_first'	=> true,
						'std'		=> '',
...
$avia_elements[] =	array(
						...
						'slug'		=> 'avia',
						'desc'		=> __( 'Check to enable maintenance mode and show or redirect all page requests to a maintenance page of your choice. This page will not be accessable and will be excluded from page lists and search results.', 'avia_framework' ),
						'id'		=> 'maintenance_mode',
						'type'		=> 'select',
						'no_first'	=> true,
						'std'		=> '',
